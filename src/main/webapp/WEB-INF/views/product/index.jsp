...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
                ...
                <c:forEach items="${list}" var="item">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/delete-pro/${item.productId}"  type="button" class="btn btn-outline-danger">Xoá</a>
                        </td>
                    </tr>
                </c:forEach>
            ...
            <a href="/add-product" type="button" class="btn btn-outline-dark">Create Product</a>
        </div>
    </div>
</div>
<!-- Optional JavaScript -->
